      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="article-hero">
          <div class="hero-background">
            <img src="{{ asset('resources/img/blog/blog-hero-3.webp') }}" alt="Machine Learning in Healthcare" class="hero-bg-image">
          ...
          <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="author-meta">
              <img src="{{ asset('resources/img/person/person-f-8.webp') }}" alt="Dr. Sarah Chen" class="author-avatar">
            ...
            <section id="diagnostics" class="content-block" data-aos="fade-up">
              ...
              <div class="content-with-media">
                <div class="media-element">
                  <img src="{{ asset('resources/img/health/diagnostics-2.webp') }}" alt="AI Diagnostic Tools" class="content-image" loading="lazy">
        ...
        <div class="author-card">
          <div class="author-header">
            <div class="author-image-container">
              <img src="{{ asset('resources/img/person/person-m-6.webp') }}" class="author-image" alt="" loading="lazy">
          ...
          <div class="comments-container">
            ...
            <div class="comment-thread">
              <div class="comment-box">
                <div class="comment-wrapper">
                  <div class="avatar-wrapper">
                    <img src="{{ asset('resources/img/person/person-f-9.webp') }}" alt="Avatar" loading="lazy">
              ...
              <div class="replies-container">
                ...
                <div class="comment-box reply">
                  <div class="comment-wrapper">
                    <div class="avatar-wrapper">
                      <img src="{{ asset('resources/img/person/person-m-9.webp') }}" alt="Avatar" loading="lazy">
                      <span class="status-indicator"></span>
                    </div>
            ...
            <div class="comment-thread">
              <div class="comment-box">
                <div class="comment-wrapper">
                  <div class="avatar-wrapper">
                    <img src="{{ asset('resources/img/person/person-f-7.webp') }}" alt="Avatar" loading="lazy">
                    <span class="status-indicator"></span>
                  </div>
